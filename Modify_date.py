...
def clean_phone(phone: str) -> str | None:
    ...
    #Check the number length and replace the 8 with a 7 at the beginning of the number 8xxxxxxxxx -> 7xxxxxxxxxx
...
def modify_date_contact(contacts: List) ->List:
    ...
    for con in contacts:
        ...
        for phone in con.get('PHONE', []):
            ...
            #The first number is retrieved from the string of numbers and is filtered.
